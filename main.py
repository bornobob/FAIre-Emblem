...
o1 = Unit((150, 4), {'hp': 30, 'atk': 4, 'range': 1, 'move': 3}, team='Order', name='Q')
o2 = Unit((150, 8), {'hp': 45, 'atk': 2, 'range': 1, 'move': 2}, team='Order', name='R')
o3 = Unit((150, 12), {'hp': 25, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='S')
o4 = Unit((150, 13), {'hp': 20, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='T')
o5 = Unit((150, 14), {'hp': 35, 'atk': 2, 'range': 1, 'move': 3}, team='Order', name='U')

o6 = Unit((152, 4), {'hp': 30, 'atk': 4, 'range': 1, 'move': 3}, team='Order', name='V')
o7 = Unit((152, 8), {'hp': 45, 'atk': 2, 'range': 1, 'move': 2}, team='Order', name='W')
o8 = Unit((152, 12), {'hp': 25, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='X')
o9 = Unit((152, 13), {'hp': 20, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='Y')
o10 = Unit((152, 14), {'hp': 35, 'atk': 2, 'range': 1, 'move': 3}, team='Order', name='Z')
