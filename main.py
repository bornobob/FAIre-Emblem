...
o2 = Unit((200, 8), {'hp': 45, 'atk': 2, 'range': 1, 'move': 2}, team='Order', name='Im a healer, but...')
...
o6 = Unit((202, 4), {'hp': 30, 'atk': 4, 'range': 1, 'move': 3}, team='Order', name='1-10-1 Yone2')
o7 = Unit((202, 8), {'hp': 45, 'atk': 2, 'range': 1, 'move': 2}, team='Order', name='Im a healer, but...2')
o8 = Unit((202, 12), {'hp': 25, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='Ziggs2')
o9 = Unit((202, 13), {'hp': 20, 'atk': 6, 'range': 2, 'move': 3}, team='Order', name='Jhon2')
o10 = Unit((202, 14), {'hp': 35, 'atk': 2, 'range': 1, 'move': 3}, team='Order', name='GrabShock2')
...
if __name__ == '__main__':
    ...
    ea = EvoluationaryAlgorithm(
        board_size=(500, 500),
        ea_units=[c1, c2, c3, c4, c5, c6, c7, c8, c9, c10],
        enemy_ucs=[oc1, oc2, oc3, oc4, oc5, oc6, oc7, oc8, oc9, oc10],
        team_ordering=['Order', 'Chaos'],
        random_seed=2112
        #2112 was mooi met pop=20, point_mutate=0.15
    )
    best_genes, scores, individuals = ea.ea(pop_size=20, epochs=epochs, point_mutate=0.30)
